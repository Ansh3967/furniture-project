...
const ItemManagement = () => {
  ...
  const handleAddItem = async () => {
    try {
      ...
      const transformedItem: Item = {
        ...
        categoryId: newItem.category?._id || (formData.category as string),
        categoryName:
  ...
  const handleEditItem = async () => {
    ...
    try {
      ...
      const transformedItem: Item = {
        ...
        categoryId: updatedItem.category?._id || (formData.category as string),
        categoryName:
  ...
  const handleToggleAvailability = async (row: Item) => {
    try {
      const newAvailability = row.availability ? "out_of_stock" : "available";
      ...
      toast({
        ...
        description: `Item is now ${newAvailability.replace("_", " ")}`,
      });
    } catch (error: any) {
      const errorMessage =
        error.response?.data?.message ||
  ...
  const handleToggleFeatured = async (row: Item) => {
    try {
      await adminService.toggleItemFeatured(row._id);
      toast({
        title: "Featured Updated",
        description: `Item featured status toggled.`,
      });
    } catch (error: any) {
      const errorMessage =
        error.response?.data?.message ||
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Upload multiple images for the item. Supported formats:
                      JPG, PNG, GIF. Max size: 10MB per file.
                    </p>
                  </div>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete the item and remove it from
                              your inventory.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground mt-1">
                    Upload new images to replace existing ones. Supported

  ...
  const sampleOrders = [
    {
      ...
      date: '2024-01-15',
      items: [
        { name: 'Premium Leather Sofa', quantity: 1, price: 24999 }
      ],
      customer: {
        name: 'Rajesh Kumar',
    ...
    },
    {
      ...
      date: '2024-01-20',
      items: [
        { name: 'Luxury King Size Bed', quantity: 1, price: 18999 }
      ],
      customer: {
        name: 'Priya Sharma',
    ...
    },
    {
      ...
      date: '2024-01-25',
      items: [
        { name: 'Teak Wood Executive Desk', quantity: 1, price: 12999 }
      ],
      customer: {
        name: 'Amit Patel',
    ...
    },
    {
      ...
      date: '2024-01-10',
      items: [
        { name: 'Luxury Wardrobe', quantity: 1, price: 15999 }
      ],
      customer: {
        name: 'Sunita Reddy',
    ...
    },
    {
      ...
      date: '2024-01-05',
      items: [
        { name: 'Gaming Desk Setup', quantity: 1, price: 7999 }
      ],
      customer: {
        name: 'Vikram Singh',
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground ml-6">{order.customer.address}</p>
                    </div>
                  </div>
